...
const ProductCard = ({ id, productCardClick, actionButtonClick, actionButton }) => {
  ...
  useEffect(() => {
    const getData = async() => {
      ...
      var defaultIndex = styles.data.results.findIndex((style) => style['default?'] === true);
      ...
      var r = reviewsMetaData.data.ratings;
