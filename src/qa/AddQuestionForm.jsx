      ...
      <div className='qa-form-container'>
        <form onSubmit={handleAddQuestion}>
          <div className='qa-form-row'>
            <label className='qa-input-label'>Nickname <span className='qa-required-input'>*</span></label>
            <input
              className='qa-input'
              name='nickname-input'
              type='text'
            ...
            <label className='qa-input-label'>Email <span className='qa-required-input'>*</span></label>
              <input
              className='qa-input'
              name='email-input'
              type='text'
          ...
          <div className='qa-form-row'>
            <label className='qa-input-label'>Question <span className='qa-required-input'>*</span></label>
            <textarea
              className='qa-input'
              name='question-input'
              type='text'
