  ...
  return (
    <div className="add-review-container">
      <div className="add-review-header">
        ...
        <span className="add-review-close-button" onClick={() => setModal(false)}>
      ...
      >
        ...
        >
          ...
          <input id="yes-recommend" name="recommend" type="radio" value />
        ...
        <div className="user-image-wrapper">
          {
            userInput.photos.map((image, index) => <img key={`userimage-${index}`} src={image} />)
          }
        </div>
